 ...
 */
#define  USB_CFG_DEVICE_ID       0x62, 0x60 /* = 0x05dc = 1500 */
 ...
 */
#define USB_CFG_VENDOR_NAME 'P','l','a','i','d'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME 'C', 'o', 'o', 'k', 'i', 'e','s', '&', 'C', 'r','e', 'a', 'm', ' ','i', 'n', ' ', 'f', 'l', 'a', 's','h', ' ', 'm', 'o','d', 'e'
